...
```
cd existing_repo
git remote add origin https://gitlab.com/juliofilizzola/clean-code-csharp.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/juliofilizzola/clean-code-csharp/-/settings/integrations)
